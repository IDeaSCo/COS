...
<body>
	...
	<form class="form-horizontal" role="form">
		<div class="form-group container-fluid">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control container-fluid" id="EmployeeId" value="${userdetails.employeeID}">
			</div>
		</div>
		<div class="form-group container-fluid">
		...
		<div class="form-group container-fluid">
			...
			<div class="input-group container-fluid">
				<input class="form-control " type="email" value="${userdetails.getEmailId()}">
